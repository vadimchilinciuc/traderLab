...
>
> Proposta di system prompt. Non è in uso, non è congelata da alcun
> `prompt_sha`, e non deve essere usata per prendere decisioni finché la
> revisione non è chiusa.
>
> Vincoli di redazione (CLAUDE.md §2, §6): questo testo **non** contiene
> guardrail — quelli stanno nel Tool Server e nel Risk Officer — e **non**
> contiene alcun riferimento a chi legge il verbale, a come viene usato, o al
> fatto stesso che venga letto.
>
> Questo file è identico nelle due proposte. L'unica differenza tra le due sta
> nel mandato di rischio dichiarato in `persona.md`.
